PlayTubeVideo v2.1 Upgrade Documentation

Note: This update is just for who is using 2.0, if you're still using older verisons, Please Upgrade the script version by version.
