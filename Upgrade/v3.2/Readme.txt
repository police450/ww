PlayTubeVideo v3.2 Upgrade Documentation

Note: This update is just for who is using 3.1, if you're still using older verisons, Please Upgrade the script version by version.
