...
router.use(process.env.subFolder+':lng?/playlist/:id',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"playlist",'view')
},controller.view);
router.get(process.env.subFolder+':lng?/playlists',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"playlist",'view')
},multer().none(),controller.browse);
router.use(process.env.subFolder+':lng?/create-playlist/:id?',(req,res,next) => {
