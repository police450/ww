...
router.use(process.env.subFolder+':lng?/audio/:id',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"audio",'view')
},controller.view);
router.get(process.env.subFolder+':lng?/audio',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"audio",'view')
},multer().none(),controller.browse);
router.use(process.env.subFolder+':lng?/create-audio/:id?',(req,res,next) => {
