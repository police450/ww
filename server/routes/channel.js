...
router.use(process.env.subFolder+':lng?/create-channel/:id?',(req,res,next) => {
...
router.use(process.env.subFolder+':lng?/channel/categories',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"channel",'view')
},controller.categories);
router.use(process.env.subFolder+':lng?/channel/category/:id',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"channel",'view')
},controller.category);
router.use(process.env.subFolder+':lng?/post/:id',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"channel",'view')
},controller.post);
router.use(process.env.subFolder+':lng?/channel/:id',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"channel",'view')
},controller.view);
router.get(process.env.subFolder+':lng?/channels',(req,res,next) => {
    middlewareEnable.isEnable(req,res,next,"channel",'view')
