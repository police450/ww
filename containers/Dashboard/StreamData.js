    ...
    saveTips = (e) => {
        ...
        tips.forEach((item,index) => {
            if(parseFloat(item.amount) > 0){
                ...
                item.error = this.props.t("Enter amount must be greater than {{price}}.",{price : parseFloat(this.props.pageData.appSettings['videotip_commission_value']) > 0 && parseInt(this.props.pageData.appSettings['videotip_commission_type']) == 1 ? Currency({...this.props,...perprice}) : 0});
                valid = false;
            }
        })
