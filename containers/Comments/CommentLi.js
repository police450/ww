                ...
                <div className="comentBody">
                    <div className="commentCnt">
                        <div className="userInfo">
                            ...
                            {
                                (props.approveCommentType != "needreview") && ((props.pageData && props.pageData.loggedInUserDetails && props.pageData.levelPermissions && (props.pageData.levelPermissions[props.commentType+".delete"] == 2 || ((props.pageData.levelPermissions[props.commentType+".delete"] == 1 || props.commentType == "artist" || props.commentType == "channel_post") && props.data.owner_id == props.pageData.loggedInUserDetails.user_id)))
                                ||
                                props.pageData && props.pageData.loggedInUserDetails && props.pageData.levelPermissions && (props.pageData.levelPermissions[props.commentType+".edit"] == 2 || ((props.pageData.levelPermissions[props.commentType+".edit"] == 1 || props.commentType == "artist")  && props.data.owner_id == props.pageData.loggedInUserDetails.user_id))) ?
                            ...
                            <div className="dropdown TitleRightDropdown">
                                ...
                                {
                                    props.pageData && props.pageData.loggedInUserDetails && props.pageData.levelPermissions && (props.pageData.levelPermissions[props.commentType+".edit"] == 2 || ((props.pageData.levelPermissions[props.commentType+".edit"] == 1 || props.commentType == "artist" || props.commentType == "channel_post")  && props.data.owner_id == props.pageData.loggedInUserDetails.user_id)) ? 
