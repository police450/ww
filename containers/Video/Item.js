...
class Item extends React.Component {
    ...
    hoverOn = () => {
        if(!this.props.canDelete && !this.props.canEdit && this.width > 992 && this.props.pageData.appSettings['video_preview'] == 1 && this.state.video.is_livestreaming != "1"){
           if(!this.state.video.password && (!this.state.video.adult || (this.state.video.adult && this.props.pageData.adultAllowed)))
    ...
    render() {
        ...
        return (
            ...
            <React.Fragment>
                {analyticsData}
                {
                    this.props.pageData.appSettings.video_advanced_grid != 1 ? 
                <div className="ptv_videoList_wrap">
                    <div className="videoList_thumb" onMouseEnter={() => this.hoverOn()} onMouseLeave={() => this.hoverOff()} >
                        <Link href="/watch" onClick={this.props.closePopUp} customParam={`id=${this.state.video.custom_url}${customParams}`} as={`/watch/${this.state.video.custom_url}${stringId}`}>
                            <a>
                                {
                                    this.state.hover && !this.state.video.purchasePackage && this.props.pageData.appSettings['player_type'] == "element" && (this.state.video.type == 3 || this.state.video.type == 1) ?
                                        <MediaElementPlayer showControls={false} updateTime={false} muted={true} {...this.props} height="188px" imageSuffix={this.props.pageData.imageSuffix} video={this.state.video} {...this.state.video} />
                                :
                                    this.state.hover && !this.state.video.purchasePackage && this.state.video.type == 3 ?
                                        <Player showControls={false} updateTime={false} muted={true} {...this.props} height="188px" imageSuffix={this.props.pageData.imageSuffix} video={this.state.video} {...this.state.video} />
                                : this.state.hover && !this.state.video.purchasePackage ?
                                        <OutsidePlayer muted={true} updateTime={false} showControls={false} {...this.props} height="188px" imageSuffix={this.props.pageData.imageSuffix} video={this.state.video}  {...this.state.video} />
                                    :
                                        <Image title={CensorWord("fn",this.props,this.state.video.title)} image={videoImage} imageSuffix={this.props.pageData.imageSuffix}  siteURL={this.props.pageData.siteURL} />
                                }
                            </a>
                        </Link>
                        {
                        ...
                        <div className="playBtn">
                            <Link href="/watch" customParam={`id=${this.state.video.custom_url}${customParams}`} as={`/watch/${this.state.video.custom_url}${stringId}`}>
                        ...
                        {
                            this.props.pageData.appSettings['videos_watchlater'] == 1 ?
                                <WatchLater className="watchlater" icon={true} {...this.props} item={this.state.video} id={this.state.video.video_id} />
                            : null
                        }
                        {
                            this.props.pageData.appSettings["videos_playlist"] == 1 && this.props.pageData.appSettings["enable_playlist"] == 1 && (!this.props.pageData.levelPermissions || this.props.pageData.levelPermissions['playlist.create'] == 1) && !playlist_id ?
                             ...
                             {
                                this.props.pageData.appSettings['videos_featuredlabel'] == 1 && this.props.pageData.appSettings['video_featured'] == 1 && this.state.video.is_featured == 1 ?
                                ...
                                : null
                                    ...
                                    {
                            this.props.pageData.appSettings['videos_sponsoredLabel'] == 1 && this.props.pageData.appSettings['video_sponsored'] == 1 && this.state.video.is_sponsored == 1 ?
                        ...
                        {
                            this.props.pageData.appSettings['videos_hotLabel'] == 1 && this.props.pageData.appSettings['video_hot'] == 1 && this.state.video.is_hot == 1 ?
                    ...
                    <div className="videoList_content">
                        <div className={`videoTitle${this.props.canDelete || this.props.canEdit  || this.props.pageData.appSettings["videos_share"] == 1 ? " edit-video-btn" : ""}`}>
                            <Link href="/watch" customParam={`id=${this.state.video.custom_url}${customParams}`} as={`/watch/${this.state.video.custom_url}${stringId}`}>
                                <a  onClick={this.props.closePopUp}>
                            ...
                            {
                                this.props.canDelete || this.props.canEdit || this.props.pageData.appSettings["videos_share"] == 1 ? 
                            <div className="dropdown TitleRightDropdown">
                                ...
                                <ul className="dropdown-menu dropdown-menu-right edit-options">
                                    ...
                                    <SocialShare {...this.props} buttonHeightWidth="30" tags={this.state.video.tags} url={`/watch/${this.state.video.custom_url}`} title={CensorWord("fn",this.props,this.state.video.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.video.image} />
                                    : null
                                    }
                                    {
                                        this.props.pageData.appSettings["videos_playlist"] == 1 && this.props.pageData.appSettings["enable_playlist"] == 1 && (!this.props.pageData.levelPermissions || this.props.pageData.levelPermissions['playlist.create'] == 1) && !playlist_id ?
                        ...
                        <div className="videoInfo">
                            ...
                            <span className="videoViewDate">
                                ...
                                {
                            this.props.pageData.appSettings["videos_views"] == "1" && this.props.pageData.appSettings["videos_datetime"] == "1" ?
                        ...
                        {
                            this.state.video.scheduled && (!this.props.pageData.loggedInUserDetails || this.state.video.owner_id != this.props.pageData.loggedInUserDetails.user_id) ? 
                        ...
                        <Link href="/watch" onClick={this.props.closePopUp} customParam={`id=${this.state.video.custom_url}${customParams}`} as={`/watch/${this.state.video.custom_url}${stringId}`}>
                            <a className="ThumbBox-link" onClick={this.props.closePopUp}>
                                <div className="ThumbBox-coverImg">
                                    <span>  
                                        <Image className={this.state.video.type == 1 ? "yt":""} title={CensorWord("fn",this.props,this.state.video.title)} image={videoImage} imageSuffix={this.props.pageData.imageSuffix}  siteURL={this.props.pageData.siteURL} />
                                    </span>
                                </div>
                            </a>
                        </Link>
