...
class Browse extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (prevState.localUpdate){
            ...
            return { videos: nextProps.pageData.videos, pagging: nextProps.pageData.pagging, page: 2, search: nextProps.search ? nextProps.search : [],pageType:nextProps.pageData.pageType }
        } else if (nextProps.pageData.videos && nextProps.pageData.videos != prevState.videos) {
            return { videos: nextProps.pageData.videos, pagging: nextProps.pageData.pagging, page: 2, search: nextProps.search ? nextProps.search : [],pageType:nextProps.pageData.pageType }
        } else {
            return null
            ...
            <React.Fragment>
                {
                    ...
                    <div className="user-area">
                        ...
                        <InfiniteScroll
                            ...
                            endMessage={
                                <EndContent {...this.props} text={this.props.pageData.search || this.props.globalSearch ?  Translate(this.props,'No video found with your matching criteria.') : Translate(this.props,'No video found to display.')} itemCount={this.state.videos.length} />
                            }
