                                                    ...
                                                    <div className="videoPlayer">
                                                        <React.Fragment>
                                                        {
                                                            ...
                                                            this.props.pageData.appSettings['player_type'] == "element" && ((this.state.video.type == 3 && this.state.video.video_location) || (
                                                                ...
                                                                <MediaElementPlayer {...this.props} upatePlayerTime={this.updatePlayerPlayTime} purchaseClicked={this.purchaseClicked} getHeight={this.getHeight} ended={this.videoEnd} height={this.props.pageData.fromAPP ? "200px" : ( this.state.width > 992 ? "550px" : "550px")} userAdVideo={this.state.userAdVideo} adminAdVideo={this.state.adminAdVideo}  playlistVideos={this.state.playlistVideos} currentPlaying={this.state.currentPlaying} imageSuffix={this.props.pageData.imageSuffix} video={this.props.pageData.video} {...this.props.pageData.video} />
                                                            : 
                                                            ((this.state.video.type == 3 && this.state.video.video_location) || (this.state.video.type == 11 && this.state.video.code))  && !this.state.video.scheduled && this.state.video.approve == 1 ?
                                                                <Player {...this.props} purchaseClicked={this.purchaseClicked} upatePlayerTime={this.updatePlayerPlayTime} getHeight={this.getHeight} ended={this.videoEnd} height={this.props.pageData.fromAPP ? "200px" : ( this.state.width > 992 ? "550px" : "550px")} userAdVideo={this.state.userAdVideo} adminAdVideo={this.state.adminAdVideo}  playlistVideos={this.state.playlistVideos} currentPlaying={this.state.currentPlaying} imageSuffix={this.props.pageData.imageSuffix} video={this.props.pageData.video} {...this.props.pageData.video} />
                                                            :
                                                            (!this.state.video.scheduled || this.state.video.approve == 1) && this.state.video.type != 11 ?
                                                                <OutsidePlayer {...this.props} liveStreamingURL={this.props.pageData.liveStreamingURL} upatePlayerTime={this.updatePlayerPlayTime} getHeight={this.getHeight} ended={this.videoEnd}  height={this.props.pageData.fromAPP ? "200px" : ( this.state.width > 992 ? "550px" : "550px")}  playlistVideos={this.state.playlistVideos} currentPlaying={this.state.currentPlaying} imageSuffix={this.props.pageData.imageSuffix} video={this.props.pageData.video}  {...this.props.pageData.video} />
                                                                ...
                                                                <div className="stats">
                                                                    ...
                                                                    <span className="date">
                                                                        ...
                                                                        <div className="subitle">
                                                                            {
                                                                                Date(this.props,this.state.video.scheduled,this.props.initialLanguage,'MMMM Do YYYY, hh:mm A',this.props.pageData.loggedInUserDetails ? this.props.pageData.loggedInUserDetails.timezone : this.props.pageData.defaultTimezone)
                                                                            }
                                                                        </div>
                                                                        : null
                                                                        }
                                                                ...
                                                                <React.Fragment>
                                                                    ...
                                                                    }
                                                                    {
                                                                        <button onClick={this.purchaseClicked}>
                                                                            {this.props.t("Pay {{price}} to watch this video.",{price:Currency({...this.props,...userBalance})})}
                                                                        </button>
                                                                    }
                                                                </React.Fragment>
                                                            : null
