...
class Player extends React.Component {
    ...
    playStart = () => {
        ...
        let sessionPassword = this.props.pageData && this.props.pageData.audioPassword ? this.props.pageData.audioPassword : []
        if(audio.view_privacy == "password" && sessionPassword.indexOf(this.props.song_id) == -1 && !audio.passwords && ( !this.props.pageData.levelPermissions || this.props.pageData.levelPermissions["audio.view"] != 2 ) 
            && (!this.props.pageData.loggedInUserDetails || this.props.pageData.loggedInUserDetails.user_id != audio.owner_id)  
        ...
        return (
            ...
            <div className="playbar">
                ...
                <audio id="audio" autoPlay preload="auto" ref={ (tag) => this.audioTag = tag }
                    src={(isS3 ? this.props.pageData.imageSuffix : "") + audio.audio_file}
                ...
                <div className="track-info">
                    ...
                    <Link  href="/audio" customParam={`id=${audio.custom_url}`} as={`/audio/${audio.custom_url}`}>
                        <a className="trackName">
                            <Image height="30px" width="30px" image={audio.image} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                        </a>
                    </Link>
                    </div>
