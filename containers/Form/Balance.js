...
class Balance extends Component {
    ...
    render() {
        ...
        let priceData = Currency({...this.props,...perclick})
        let formFields = [
            { key: "wallet", label: "Wallet Total",props: { readOnly: true }, value: Currency({...this.props,...wallet}) },
            { key: "balance", label: "Available Balance",props: { readOnly: true }, value: Currency({...this.props,...userBalance}) },
