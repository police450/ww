...
class Password extends Component {
    ...
    render() {
        ...
        formFields.push(
            ...
            { key: "price", props: { readOnly: this.state.plan ? true : false }, label: `Price Monthly (${this.props.pageData.appSettings.payment_default_currency})`,type:"text" ,isRequired:true,value:this.state.plan ? this.state.plan.price.toString() : ""},
            {
                key: "res_type_1",
                type: "content",
            ...
            { key: "image", label: "Upload Image", type: "file", value: this.state.plan && this.state.plan.orgImage ? this.props.pageData.imageSuffix+this.state.plan.orgImage : "" },
        )
       
        if(this.props.pageData.categoriesVideo){
            let categories = this.props.pageData.categoriesVideo
            let selected = []
