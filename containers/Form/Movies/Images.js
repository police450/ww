    ...
    render(){
        ...
        return (
            <div className="movie_photos">
                    ...
                    <input className="fileNone" onChange={this.uploadImage.bind(this)} accept="image/*"  ref={imageref} type="file" />
                    <ul className="movie_photos_cnt">
                        {
                            this.state.images.map((item,index) => {
                                return (
                                    <li className="image" key={item.photo_id}>
                                        <Image className="img" image={item.image} title={""} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
