...
class AddCast extends Component {
    ...
    render(){
        ...
        if(!this.state.editItem){
            ...
            formFields.push(
                { key: "cast_crew_member_id",type:"autosuggest",id:this.state.editItem ? this.state.editItem.cast_crew_id : "",imageSuffix:this.props.pageData.imageSuffix,url:config.app_server+"/api/movies/cast/auto-suggest"+(this.props.fromCastnCrew ? "/movie" : ""),placeholder:"Search for a member...",suggestionValue:suggestionValue, label: "Cast Member", value: this.state.editItem ? this.state.editItem.name : null ,isRequired:true},
            )
        }else{
            formFields.push(
        ...
        if(!this.props.isCrew){
            ...
            formFields.push(
                { key: "job", type:"autosuggest",departmentJob:this.props.pageData.departments, label: "Job", value: this.state.editItem ? this.state.editItem.job : null ,isRequired:true},
