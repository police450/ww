                                ...
                                <div className="tab-content">
                                    <div className="details-tab-box">
                                        <div className="social-share">
                                            ...
                                            <ul className="share">
                                            <SocialShare countItems={30} {...this.props} hideTitle={true} url={`/${this.state.member.username}`} title={this.state.member.displayname} imageSuffix={this.props.pageData.imageSuffix} media={this.state.member.avtar} />
                                            </ul>
                                        </div>
                                        {
                                                        ...
                                                        <div className="sdbrTopComments-row" key={item.user_id}>
                                                            <div className="imgbox">
                                                                <Link href="/member" customParam={`id=${item.username}`} as={`/${item.username}`}>
                                                                    <a >
                                                                        <Image className="img" title={item.displayname} image={item.avtar} imageSuffix={this.props.pageData.imageSuffix}  siteURL={this.props.pageData.siteURL} />
                                                                    </a>
                                                                </Link>
                                                            </div>
                                                            <div className="content">
                                                                <Link href="/member" customParam={`id=${item.username}`} as={`/${item.username}`}>
                                                                    <a className="UserName">
                                                                        <React.Fragment>
                                                                            {item.displayname}
                                                                            {
                                                                                this.props.pageData.appSettings['member_verification'] == 1 && item.verified == 1 ?
                                                                ...
                                                                {this.props.t("Donated: {{price}}",{price:Currency({...this.props,...userBalance})})}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    )
