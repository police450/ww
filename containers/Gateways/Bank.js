                    ...
                    <div className="comments">
                        <div className="VideoDetails-commentWrap">
                            ...
                            <form className="bank-form" onSubmit={this.handleSubmit}>
                                <p>
                                    {
                                         this.props.pageData.appSettings['payment_bank_method_description']
                                    }
                                </p>
                                <p className="note">
                                    {
                                        this.props.pageData.appSettings['payment_bank_method_note']
                                    }
                                </p>
                                <input type="file" accept="image/*" name="file" onChange={this.selectFile} />
