...
class Index extends React.Component {
    ...
    render() {       
        ...
        const donationVideo = this.props.pageData.appSettings['video_donation']
        const sellVideo = this.props.pageData.appSettings['video_sell']
        const channelEnable = this.props.pageData.appSettings['enable_channel']
        const moviesEnable = this.props.pageData.appSettings['enable_movie']
        const blogEnable = this.props.pageData.appSettings['enable_blog']
        const playlistEnable = this.props.pageData.appSettings['enable_playlist']
        const audioEnable = this.props.pageData.appSettings['enable_audio']
        const adsEnable = this.props.pageData.appSettings['enable_ads']
        const memberHot = this.props.pageData.appSettings['member_hot']
        const memberSponsored = this.props.pageData.appSettings['member_sponsored']
        const memberFeatured = this.props.pageData.appSettings['member_featured']
        const livestreamingEnable = this.props.pageData.appSettings['live_stream_start']
            ...
            <React.Fragment>
                {gatewaysHTML}
                    <div className="titleBarTop">
                        <div className="titleBarTopBg"><img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"}
