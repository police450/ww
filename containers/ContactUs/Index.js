            ...
            <React.Fragment>
                    <div className="titleBarTop">
                        <div className="titleBarTopBg">
                            <img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"} alt={this.props.t("Contact Us")} />
                        </div>
                                ...
                                <div className="col-md-12 position-relative">
                                    <div className="ContentBoxTxt">
                                        <div className="contact-area">
                                            {
                                                this.props.pageData.appSettings['contact_map'] ?
                                                    <div className="gmap">
                                                        <iframe src={this.props.pageData.appSettings['contact_map']} width="100%" height="500" frameBorder="0" style={{ border: "0" }} allowFullScreen></iframe>
                                                    </div>
                                                    : null
                                            }
                                            <div className="container">
