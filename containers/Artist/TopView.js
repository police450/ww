                    ...
                    <div className="col-md-12 position-relative">
                        <div className="channelInfo-wrap artistDetailsWrap">
                            <div className="playlist-profile-img">
                                <Image title={this.state.artist.title} width="170" height="170" image={this.state.artist.image} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                            </div>
                            ...
                            <div className="LikeDislikeWrap">
                                <ul className="LikeDislikeList">
                                    ...
                                    <SocialShare {...this.props} hideTitle={true} buttonHeightWidth="30" url={`/artist/${this.state.artist.custom_url}`} title={CensorWord("fn",this.props,Translate(this.props,this.state.artist.title))} imageSuffix={this.props.pageData.imageSuffix} media={this.state.artist.image} />
                                </ul>
                            </div>
                            </div>
                        </div>
