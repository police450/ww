        ...
        return (
            <div className="single-user">
                <div className={`img${this.props.className ? " "+this.props.className : ""}`}>
                    <Link href="/artist" customParam={`id=${this.state.artist.custom_url}`} as={`/artist/${this.state.artist.custom_url}`}>
                        <a>                        
                            <Image title={CensorWord("fn",this.props,Translate(this.props,this.state.artist.title))} image={this.state.artist.image} siteURL={this.props.pageData.siteURL} imageSuffix={this.props.pageData.imageSuffix} />
                        </a>
                    </Link>
                </div>
                    <div className="content">
                        ...
                        {
                        this.props.pageData.appSettings["artists_browse_like"] == "1" ?
                            <li>
                        ...
                        {
                            this.props.pageData.appSettings["artists_browse_dislike"] == "1" ?
                            <li>
                        ...
                        : null
                            ...
                            {
                                this.props.pageData.appSettings["artists_browse_favourite"] == "1" ?
                            <li>
                        ...
                        {
                            this.props.pageData.appSettings["artists_browse_share"] == "1" ?
                            <SocialShare {...this.props} hideTitle={true} buttonHeightWidth="30" url={`/playlist/${this.state.artist.custom_url}`} title={CensorWord("fn",this.props,Translate(this.props,this.state.artist.title)) } imageSuffix={this.props.pageData.imageSuffix} media={this.state.artist.image} />
                        :null
                        }
                        </ul>
                        </div>
