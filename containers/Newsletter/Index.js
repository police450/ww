...
class Newsletter extends Component {
    ...
    render() {
        if(this.props.pageData.appSettings['enable_newsletter'] != 1){
            return null
        }
        let image = "static/images/newsletter-bg.jpg";
        if(this.props.pageData.appSettings['newsletter_background_image']){
            image = this.props.pageData.imageSuffix+this.props.pageData.appSettings['newsletter_background_image']
        }
        return (
