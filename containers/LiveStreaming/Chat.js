...
class Chat extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            showTab:"chat",
            finish:props.finish,
            banusers:props.pageData.video && props.pageData.video.banusers ? props.pageData.video.banusers : [],
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if(prevState.localUpdate){
            ...
            return {
                ...
                tipsData:[],
                hide:false,
                banusers:nextProps.pageData.video && nextProps.pageData.video.banusers ? nextProps.pageData.video.banusers : [],
                banEnable:nextProps.pageData.banEnable ? nextProps.pageData.banEnable  : 0,
                tipsTip:{}
            }
        } else{
            return null
    ...
    postComment = () => {
        if(this.state.comment && this.props.pageData.loggedInUserDetails){
            let bannedUser = this.getUserIndex(this.props.pageData.loggedInUserDetails.user_id);
            if(bannedUser > -1){
                this.props.openToast(this.props.t("You are banned."), "error");
                return
            }
            ...
            data.displayname = this.props.pageData.loggedInUserDetails.displayname
            data.user_id = this.props.pageData.loggedInUserDetails.user_id
            data.image = this.props.pageData.loggedInUserDetails.avtar
    ...
    render(){
        let mainPhoto = this.props.pageData.loggedInUserDetails ? this.props.pageData.loggedInUserDetails.avtar : null
                                    ...
                                    let commentImage = comment.image
                                        if (comment.image) {
                                            ...
                                            if (splitVal[0] == "http:" || splitVal[0] == "https:") {
                                                ...
                                                commentImage = this.props.pageData.imageSuffix + comment.image
                                            }
                                        }
                                        ...
                                        return (
                                            <div className={`chatListRow${params.tip ? " tip" :""}`} key={comment.chat_id}>
                                                ...
                                                <div className="chatMessege">
                                                    <a href={this.props.pageData.siteURL+"/"+comment.username} target="_blank" className="name">{comment.displayname}</a> 
                                                ...
                                                {
                                                    this.props.deleteAll || (this.props.pageData.loggedInUserDetails && (this.props.pageData.loggedInUserDetails.user_id == comment.user_id || this.props.pageData.loggedInUserDetails.level_id == 1)) ? 
                ...
                <div className="Chattexttyping">
                    {
                        ...
                        <React.Fragment>
                            <div className="userName">
                                ...
                                <span className="name">{this.props.pageData.loggedInUserDetails.displayname}</span>
                            </div>
