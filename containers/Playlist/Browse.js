            ...
            <React.Fragment>
                {
                    ...
                    <div className="user-area">
                        ...
                        <InfiniteScroll
                            ...
                            endMessage={
                                <EndContent {...this.props} text={this.props.pageData.search || this.props.globalSearch ?  Translate(this.props,'No playlist found with your matching criteria.') : Translate(this.props,'No playlist created yet.')} itemCount={this.state.playlists.length} />
                            }
