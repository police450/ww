            ...
            <React.Fragment>
                ...
                <div className="ptv_playlistGrid">
                    <div className="playlistGrid_thumb">
                        <Image className="img-fluid" title={CensorWord("fn",this.props,this.state.playlist.title)} image={this.state.playlist.image} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                        ...
                        <div className="overlayPlayBtn">
                            {
                                ...
                                <Link href="/watch" customParam={`id=${this.state.playlist.vcustom_url}&list=${this.state.playlist.custom_url}`} as={`/watch/${this.state.playlist.vcustom_url}?list=${this.state.playlist.custom_url}`}>
                                    ...
                                    :
                                    <Link href="/playlist" customParam={`id=${this.state.playlist.custom_url}`} as={`/playlist/${this.state.playlist.custom_url}`}>
                                        <a className="verticalCenter btnText"  onClick={this.props.closePopUp}>
                                            <span className="playListPlayBtn"><span className="material-icons" data-icon="play_arrow"></span> {Translate(this.props, "Play All")}</span>
                                        </a>
                                    </Link>
                        ...
                        {
                            this.props.pageData.appSettings['playlists_browse_featuredlabel'] == 1 && this.props.pageData.appSettings['playlist_featured'] == 1 && this.state.playlist.is_featured == 1 ?
                        ...
                        {
                            this.props.pageData.appSettings['playlists_browse_sponsoredLabel'] == 1 && this.props.pageData.appSettings['playlist_sponsored'] == 1 && this.state.playlist.is_sponsored == 1 ?
                        ...
                        {
                            this.props.pageData.appSettings['playlists_browse_hotLabel'] == 1 && this.props.pageData.appSettings['playlist_hot'] == 1 && this.state.playlist.is_hot == 1 ?
                    ...
                    <div className="playlistGrid_content">
                        <div className={`videoTitle${this.props.canDelete || this.props.canEdit  || this.props.pageData.appSettings["playlists_browse_share"] == 1 ? " edit-video-btn" : ""}`}>
                            <Link href="/playlist" customParam={`id=${this.state.playlist.custom_url}`} as={`/playlist/${this.state.playlist.custom_url}`}>
                            ...
                            {
                                this.props.canDelete || this.props.canEdit || this.props.pageData.appSettings["playlists_browse_share"] == 1 ? 
                                ...
                                <ul className="dropdown-menu dropdown-menu-right edit-options">
                                    {
                                        this.props.canEdit ?
                                        <li>
                                            <Link href="/create-playlist" customParam={`id=${this.state.playlist.custom_url}`} as={`/create-playlist/${this.state.playlist.custom_url}`}>
                                    ...
                                    {
                                        this.props.pageData.appSettings["playlists_browse_share"] == 1 ?
                                        <SocialShare {...this.props} buttonHeightWidth="30" url={`/playlist/${this.state.playlist.custom_url}`} title={CensorWord("fn",this.props,this.state.playlist.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.playlist.image} />
                                        : null
                                    }
                                </ul>
                            </div>
                        ...
                        <div className="videoInfo">
                            {
                            this.props.pageData.appSettings["playlists_browse_username"] == "1" ?
                            ...
                            <span className="videoViewDate">
                                {
                                    this.props.pageData.appSettings["playlists_browse_views"] == "1" ?                                   
                                ...
                                {
                                this.props.pageData.appSettings["playlists_browse_views"] == "1" && this.props.pageData.appSettings["playlists_browse_datetime"] == "1" ?
                                 <span className="seprater">|</span>
                                : null
                                }
                                {
                                this.props.pageData.appSettings["playlists_browse_datetime"] == "1" ?
                        ...
                        <div className="LikeDislikeWrap">
                            <ul className="LikeDislikeList">
                                {
                                this.props.pageData.appSettings["playlists_browse_like"] == "1" ?
                                    <li>
                                ...
                                {
                                        this.props.pageData.appSettings["playlists_browse_dislike"] == "1" ?
                                    <li>
                                        <div className="actionbtn">
                                    ...
                                    {
                                        this.props.pageData.appSettings["playlists_browse_favourite"] == "1" ?
                                    <li>
                                        <div className="actionbtn">
