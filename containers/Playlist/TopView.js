...
class TopView extends React.Component {
    ...
    render() {
        ...
        if (this.state.playlist.image) {
            mainPhoto = this.props.pageData.imageSuffix + this.state.playlist.image
        } else {
            mainPhoto = this.props.pageData.imageSuffix + this.props.pageData.appSettings["playlist_default_photo"]
        }
        return (
                    ...
                    <div className="col-md-12 position-relative">
                        <div className="channelInfo-wrap">
                            <div className="playlist-profile-img">
                                <Image title={CensorWord("fn",this.props,this.state.playlist.title)} width="170" height="170" image={mainPhoto} imageSuffix={this.props.pageData.imageSuffix}  siteURL={this.props.pageData.siteURL} />
                            </div>
                            <div className="playlist-profile-title">
                                ...
                                <div className="ChannelMoreinfo">
                                    ...
                                    {
                                        this.props.pageData.appSettings['playlist_featured'] == 1 && this.state.playlist.is_featured == 1 ?
                                    ...
                                    {
                                        this.props.pageData.appSettings['playlist_sponsored'] == 1 && this.state.playlist.is_sponsored == 1 ?
                                    ...
                                    {
                                        this.props.pageData.appSettings['playlist_hot'] == 1 && this.state.playlist.is_hot == 1 ?
                                    ...
                                    {
                                        this.props.pageData.appSettings[`${"playlist_like"}`] == 1  && this.state.playlist.approve == 1 ?
                                            <li>
                                    ...
                                    {
                                        this.props.pageData.appSettings[`${"playlist_dislike"}`] == 1  && this.state.playlist.approve == 1 ?
                                            <li>
                                    ...
                                    {
                                        this.props.pageData.appSettings[`${"playlist_favourite"}`] == 1  && this.state.playlist.approve == 1 ?
                                            <li>
                                    ...
                                    this.state.playlist.approve == 1 ? 
                                        <SocialShare {...this.props} hideTitle={true} tags={this.state.playlist.tags} url={`/playlist/${this.state.playlist.custom_url}`} title={this.state.playlist.title} imageSuffix="" media={mainPhoto} />
                                    : null
                                    }
...
export default connect(null, mapDispatchToProps, null)(TopView);