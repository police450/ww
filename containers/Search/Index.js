...
class Index extends React.Component{
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if(prevState.localUpdate){
            ...
            const search = nextProps.pageData.search
            return {
                fields:{
                    categories:search && search.category_id ? search.category_id : "",
                    subCategory:search && search.subcategory_id ? search.subcategory_id : "",
    ...
    render(){
        ...
        for (var key in this.state.sort) {
            ...
            }else if(key == "favourite" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") + this.props.type+'_favourite'] == 1){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "view"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "like" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_like'] == "1"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "dislike" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_dislike'] == "1"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "rated" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_rating'] == "1"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "commented" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_comment'] == "1"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
            }else if(key == "rated" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_rating'] == "1"){
                sortArray.push({key:key,value:Translate(this.props,this.state.sort[key])})
        ...
        for(var key in this.state.type){
            if(key == "featured" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_featured'] == 1){
                typeArray.push({key:key,value:Translate(this.props,this.state.type[key])})
            }else if(key == "sponsored" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_sponsored'] == 1){
                typeArray.push({key:key,value:Translate(this.props,this.state.type[key])})
            }else if(key == "hot" && this.props.pageData.appSettings[(this.props.subtype ? this.props.subtype+"_" : "") +this.props.type+'_hot'] == 1){
                typeArray.push({key:key,value:Translate(this.props,this.state.type[key])})
            }
        }
                        ...
                        <div className="grid-menu justify-content-between search-form">
                            <form className="row gy-3" onSubmit={this.submitForm.bind(this)}>
                                ...
                                }
                                {
                                    ...
                                    <React.Fragment>
                                        {
                                            this.props.pageData.spokenLanguage && this.props.pageData.spokenLanguage.length > 0 ? 
                                                <div className="form-group col-sm-4">
                                                    ...
                                                    <select onChange={this.changeLanguage} className="form-control form-select" value={this.state.fields.language}>
                                                        ...
                                                        {
                                                            this.props.pageData.spokenLanguage.map(res => {
                                                                return (
                                        ...
                                        {
                                            this.props.pageData.countries && this.props.pageData.countries.length > 0 ?  
                                                <div className="form-group col-sm-4">
                                                    ...
                                                    <select onChange={this.changeCountry} className="form-control form-select" value={this.state.fields.country}>
                                                        ...
                                                        {
                                                            this.props.pageData.countries.map(res => {
                                                                return (
