...
class Index extends Component {
  ...
  render() {
    ...
    if(this.state.url.indexOf("/watch") > -1 && this.props.pageData.loggedInUserDetails){
    ...
    const emailTitle = CensorWord("fn",this.props,title)
    const emailBody = CensorWord("fn",this.props,"")
