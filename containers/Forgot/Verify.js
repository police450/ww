...
class Form extends Component {
    ...
    onSubmit = (e) => {
        ...
        formData.append("code", this.props.pageData.code)
            ...
            <React.Fragment>
                    <div className="titleBarTop">
                        <div className="titleBarTopBg">
                            <img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"} alt={this.props.t("Reset Password")} />
                        </div>
