                    ...
                    <div className="user-area">
                        
                            {
                                ...
                                <InfiniteScroll
                                    ...
                                    endMessage={
                                        <EndContent {...this.props} text={this.props.pageData.search || this.props.globalSearch ?  Translate(this.props,'No blog found with your matching criteria.') : Translate(this.props,'No blog created yet.')} itemCount={this.state.blogs.length} />
                                    }
