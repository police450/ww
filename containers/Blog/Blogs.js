...
class Browse extends React.Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        }else if (nextProps.pageData.blogs && nextProps.blogs != prevState.blogs) {
            return { blogs: nextProps.pageData.blogs.results, pagging: nextProps.pageData.blogs.pagging, page: 2 }
        } else{
            return null
        }
    }
