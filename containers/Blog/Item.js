            ...
            <React.Fragment>
                ...
                <div className="snglblog-block clearfix" key={this.state.blog.blog_id}>
                    ...
                    <div className={`blogContent${this.props.canDelete || this.props.canEdit  || this.props.pageData.appSettings["blogs_browse_share"] == 1 ? " edit-blog-btn" : ""}`}>                        
                        <Link href={`/blog`} customParam={`id=${this.state.blog.custom_url}`} as={`/blog/${this.state.blog.custom_url}`}>
                            <a className="blogTitle"  onClick={this.props.closePopUp}>{CensorWord("fn",this.props,this.props,this.state.blog.title)}</a>
                        </Link>
                        {
                                ...
                                <div className="dropdown TitleRightDropdown">
                                    ...
                                    }
                                    {
                                        this.props.pageData.appSettings['blogs_browse_share'] == 1 ?
                                            <SocialShare {...this.props} buttonHeightWidth="30" round="true" tags={this.state.blog.tags} url={`/blog/${this.state.blog.custom_url}`} title={CensorWord("fn",this.props,this.props,this.state.blog.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.blog.image} />
                                            : null
                                    }
                                    </ul>
                                </div>
