            ...
            <React.Fragment>
                <div className="communty-content d-flex">
                    <div className="profileImg">
                        <Link href="/channel" customParam={`id=${this.state.post.channel_custom_url}`} as={`/channel/${this.state.post.channel_custom_url}`}>
                            <a>
                                <Image height="40" width="40" title={this.state.post.channel_name} image={this.state.post.avtar} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                            </a>
                        </Link>
                    </div>
                    <div className="content flex-grow-1">
                        <div className="postBy"> 
                            ...
                            <div className="pdate">
                                <Link  href="/post" customParam={`id=${this.state.post.post_id}`} as={`/post/${this.state.post.post_id}`}>
                                    ...
                                    <div className="community-post-img">
                                        {
                                            this.state.post.image ? 
                                                <Image lazyLoad={true} image={this.state.post.image} className="img-fluid" imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                                        : null
                                        }
                                    </div>
                                </a>
