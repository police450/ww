...
class Browse extends React.Component{
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        } else if (nextProps.pageData.channels && nextProps.pageData.channels != prevState.channels) {
            return {channels:nextProps.pageData.channels,pagging:nextProps.pageData.pagging,page:2}
        } else{
            return null
        }
            ...
            <React.Fragment>
                    <div className="user-area">
                        ...
                        <InfiniteScroll
                            ...
                            endMessage={
                                <EndContent {...this.props} text={this.props.pageData.search ?  Translate(this.props,'No channel found with your matching criteria.') : Translate(this.props,'No channel created yet.')} itemCount={this.state.channels.length} />
                            }
