                                    ...
                                    <div className="tab-content" id="myTabContent">
                                        <div className="tab-pane active show" id="comments" role="tabpanel">
                                            <div className="details-tab-box">
                                                <Comment  {...this.props}  hideTitle={true}  appSettings={this.props.pageData.appSettings} commentType="channel_post" type="channel_posts" comment_item_id={this.state.post.post_id} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
