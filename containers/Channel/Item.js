    ...
    render() {
        ...
        return (
            <React.Fragment>
                {analyticsData}
                {
                    this.props.pageData.appSettings.channel_advanced_grid != 1 ? 
                    <div className="snglChnnl-block clearfix">
                        <Link href="/channel" customParam={`id=${this.state.channel.custom_url}`} as={`/channel/${this.state.channel.custom_url}`}>
                            <a className="snglChnnl-coverimg" onClick={this.props.closePopUp}>
                                <Image className="img-fluid" layout="fill" title={CensorWord("fn",this.props,this.state.channel.title)} image={this.state.channel.cover_crop ? this.state.channel.cover_crop : this.state.channel.cover} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                                <div className="lbletop">
                                    {
                                        this.props.pageData.appSettings['channels_browse_featuredlabel'] == 1 && this.props.pageData.appSettings['channel_featured'] == 1 && this.state.channel.is_featured == 1 ?
                                    ...
                                    {
                                        this.props.pageData.appSettings['channels_browse_sponsoredLabel'] == 1 && this.props.pageData.appSettings['channel_sponsored'] == 1 && this.state.channel.is_sponsored == 1 ?
                                    ...
                                    {
                                        this.props.pageData.appSettings['channels_browse_hotLabel'] == 1 && this.props.pageData.appSettings['channel_hot'] == 1 && this.state.channel.is_hot == 1 ?
                        ...
                        <div className="snglChnnl-content">
                            <div className="userImg">
                                <Link href="/channel" customParam={`id=${this.state.channel.custom_url}`} as={`/channel/${this.state.channel.custom_url}`}>
                                    <a  onClick={this.props.closePopUp}>
                                        <Image className="img-fluid" height={110} width={110} title={CensorWord("fn",this.props,this.state.channel.title)} image={this.state.channel.image} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                                    </a>
                                </Link>
                            </div>
                            <div className="videoList_content">
                                <div className={`videoTitle${this.props.canDelete || this.props.canEdit  || this.props.pageData.appSettings["channels_browse_share"] == 1 ? " edit-video-btn" : ""}`}>
                                    <Link href="/channel" customParam={`id=${this.state.channel.custom_url}`} as={`/channel/${this.state.channel.custom_url}`}>
                                    ...
                                    {
                                            this.props.canDelete || this.props.canEdit || this.props.pageData.appSettings["channels_browse_share"] == 1 ? 
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-right edit-options">
                                                {
                                                    this.props.canEdit ?
                                                        <li>
                                                            <Link href="/create-channel" customParam={`id=${this.state.channel.custom_url}`} as={`/create-channel/${this.state.channel.custom_url}`}>
                                                                <a>
                                                ...
                                                {
                                                    this.props.pageData.appSettings["channels_browse_share"] == 1 ?
                                                    <SocialShare {...this.props} buttonHeightWidth="30" url={`/channel/${this.state.channel.custom_url}`} title={CensorWord("fn",this.props,this.state.channel.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.channel.image} />
                                                    : null
                                                }
                                            </ul>
                                        </div>
                            ...
                            <div className="channelInfo">
                                {
                                this.props.pageData.appSettings["channels_browse_username"] == "1" ?
                                ...
                                <span className="channelViewDate">
                                    {
                                        this.props.pageData.appSettings["channels_browse_views"] == "1" ?                                   
                                    ...
                                    {
                                    this.props.pageData.appSettings["channels_browse_views"] == "1" && this.props.pageData.appSettings["channels_browse_datetime"] == "1" ?
                                        <span className="seprater">|</span>
                                    : null
                                    }
                                    {
                                    this.props.pageData.appSettings["channels_browse_datetime"] == "1" ?
                            ...
                            {
                                this.props.pageData.appSettings['channels_browse_videoscount'] == 1 || this.props.pageData.appSettings['channels_browse_subscribecount'] == 1  ? 
                            <div className="videono">
                                {
                                    this.props.pageData.appSettings['channels_browse_videoscount'] == 1 ? 
                                ...
                                {
                                    this.props.pageData.appSettings['channels_browse_subscribecount'] == 1 ? 
                            ...
                            {
                                this.props.pageData.appSettings['channels_browse_subscribe'] == 1 ? 
                            ...
                            <div className="LikeDislikeWrap">
                                ...
                                {
                                this.props.pageData.appSettings["channels_browse_like"] == "1" ? 
                                    <li>
                                ...
                                {
                                    this.props.pageData.appSettings["channels_browse_dislike"] == "1" ? 
                                <li>
                                ...
                                {
                                    this.props.pageData.appSettings["channels_browse_favourite"] == "1" ? 
                                <li>
                    ...
                    <Link href="/channel" customParam={`id=${this.state.channel.custom_url}`} as={`/channel/${this.state.channel.custom_url}`}>
                        <a className="ThumbBox-link" onClick={this.props.closePopUp}>
                            <div className="ThumbBox-coverImg">
                                <span>
                                    <Image className="img-fluid" title={CensorWord("fn",this.props,this.state.channel.title)} image={this.state.channel.image} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                                </span>
                            </div>    
                        </a>
                    </Link>
